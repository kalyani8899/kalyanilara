            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Here is a Blog List</p>
                </div>
                <form method="post" id="basicform" action="{{route('store.form.delete')}}">
				        @csrf                
               <a href="{{route('store.form')}}" class="btn btn-primary pull-right">Add New </a>
                    ...
                    <table class="table">
                      ...
                      @foreach($data as $d)
                        ...
                        <td><a href="{{route('store.form.edit',$d->id)}}">Edit</a>
                            <a href="{{route('store.form.delete',$d->id)}}" onclick="alert('Successfully Deleted!')">Delete</a>
                        </td>
                        </tr>
                    @endforeach
                      </tbody>
